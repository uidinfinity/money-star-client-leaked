...
import me.money.star.client.modules.render.HoleESP;
...
import me.money.star.util.world.BlockUtil;
 ...
 * @since 1.0
 */
public class HoleManager implements Util {
    ...
    public List<BlockPos> getSphere(Vec3d start)
    {
        ...
        double rad = Math.ceil(Math.max(5.0, HoleESP.getInstance().getRange()));
