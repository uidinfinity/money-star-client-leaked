...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : MoneyStar.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : MoneyStar.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = MoneyStar.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = MoneyStar.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
